...
- `start/index.html`: introduction, selected work, about preview, expertise and contact.
- `start/profile.html`: complete profile, all seven projects, skills, career history, certifications, references and contact form.
...
- `start/assets/js/home.js`: selected-work filters and project details.
